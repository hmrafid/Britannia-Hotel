<div
      class="container-fluid bg-dark text-light p-3 d-flex aligh-items-center justify-content-between sticky-top"
    >
      <h3 class="mb-0 h-font">Britannia Hotel Website</h3>
